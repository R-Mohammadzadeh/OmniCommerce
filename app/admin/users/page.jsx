...
// Die Komponente muss als Standard-Export (default) definiert sein
...
try {
  ...
  // Konvertierung von MongoDB-Objekten zu Standard-JSON
...
return (
        ...
        <ul className="divide-y divide-slate-50 dark:divide-slate-800/50">
          {users.map((user) => (
            ...
            >
              ...
              {/* Neuer Abschnitt für Aktionsschaltflächen */}
  ...
  <button className="flex border justify-center my-8 mx-auto transition-all hover:bg-blue-500
    ...
    <Link className="flex justify-center" href='/admin' >Admin</Link>
  </button>
  </>
);
}