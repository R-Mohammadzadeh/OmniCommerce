    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-20 max-w-4xl mx-auto">
        {dict.values.map((value, index) => {
          const icons = [FaHandshake, FaBolt, FaShieldAlt, FaGem];
            ...
            >
              <div className="relative w-32 h-32 mx-auto mb-6">
                <img
                  src={member.image}
                  alt={member.name}
                  className="rounded-full w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500 border-4 border-slate-50 dark:border-slate-800"
                />
              ...
              <div className="p-10 flex justify-center gap-10 text-slate-500 dark:text-slate-400 text-xl">
